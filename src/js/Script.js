    ...
    document.querySelector("#ulMain").innerHTML += `
        ...
        <div class="row ai-ce">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 row ai-ce jc-se prices">
                ...
                <p class="thePercent"> ${eval(element.h1).toFixed(5)}
...
const verifyPercentChange = (valor) => {
  if (valor > 0) {
    return `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-graph-up-arrow text-green graph" viewBox="0 0 16 16">
      <path fill-rule="evenodd" d="M0 0h1v15h15v1H0V0Zm10 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0V4.9l-3.613 4.417a.5.5 0 0 1-.74.037L7.06 6.767l-3.656 5.027a.5.5 0 0 1-.808-.588l4-5.5a.5.5 0 0 1 .758-.06l2.609 2.61L13.445 4H10.5a.5.5 0 0 1-.5-.5Z" />
  </svg>`;
  } else {
    return `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-graph-down-arrow text-red graph" viewBox="0 0 16 16">
